...
const styles = StyleSheet.create({
  ...
  goldBtn: { flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: M.bgSoft, paddingHorizontal: 12, paddingVertical: 7, borderRadius: RADIUS.pill, borderWidth: 1, borderColor: M.border },
  goldText: { color: M.text, fontWeight: '800', fontSize: 13 },
  ...
  compatBadge: {
    position: 'absolute', top: 14, left: 14, backgroundColor: 'rgba(17,17,17,0.92)',
  ...
  instantBtn: {
    ...
    borderRadius: RADIUS.pill, backgroundColor: M.bgSoft, borderWidth: 1, borderColor: M.border,
  },
  instantText: { color: M.text, fontWeight: '800', fontSize: 13.5 },
